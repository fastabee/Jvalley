...
<body>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo base_url('c/pas') ?>" enctype="multipart/form-data" method="post">
            <table>
                <tr>
                    <input type="text" name="id_user" value="<?php echo $id ?>" hidden id="">
                    <td class="label">Masukan Password Baru :</td>
                    <td><input type="text" name="password" class="input" required /></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <button type="submit" class="tbl-biru">Simpan</button>
